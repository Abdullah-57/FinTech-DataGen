...
class TestAPIEndpoints(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_db.get_latest_data.return_value = self.mock_dataset
        self.mock_db.save_prediction.return_value = None
        self.mock_db.save_forecast.return_value = MagicMock(inserted_id='pred_id')
    ...
    def test_generate_data_endpoint(self, mock_db, mock_curator):
        ...
        # Mock database save
        mock_db.save_dataset.return_value = MagicMock(inserted_id='test_id')
    ...
    def test_get_dataset_by_id(self):
        ...
        response = self.client.get('/api/datasets/test_id')
    ...
    def test_analytics_endpoint(self):
        ...
        self.assertEqual(data['accuracy'], 85.5)
